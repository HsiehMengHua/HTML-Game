...
(function(){
    ...
    [
        ...
        { src: 'game_sample/js/myGame.js', lookFor: 'MyGame' },
        { src: 'game_sample/js/Menu.js', lookFor: 'Menu' },
        { src: 'game_sample/js/GameMap.js', lookFor: 'GameMap' },
        { src: 'game_sample/js/Player.js', lookFor: 'Player' },
        { src: 'game_sample/js/character_ex.js', lookFor: 'Character_ex' },
        { src: 'game_sample/js/character.js', lookFor: 'Character' },
        { src: 'game_sample/js/myGameLevel1.js', lookFor: 'GameLevel' },
